...
You are responsible for maintaining a persistent record of agent discussions. After each interaction, generate a concise summary of the discussion and append it to a history file located at the root of the project.
...
- Store all summaries in a single file named `.docs_and_plans/agent_discussion_history.md` at the root of the project.
...
- If the file exists, append the new summary to the end.
